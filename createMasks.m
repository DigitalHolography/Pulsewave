...
graphSignal(ToolBox, 'everySignal', folder, t, ...
    squeeze(vascularSignal), '--', cVascular, ...
    squeeze(arterialSignal), '-', cArtery, ...
    squeeze(venousSignal), '-', cVein, ...
    Title='Signals used for correlation maps', xlabel = tLabel, ylabel = yLabel)
