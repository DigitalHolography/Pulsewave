function [mask, R_Vessel] = processVascularSignal(M0_ff_video, maskClean, maskVesselnessClean, params, cmap, prefix, ToolBox)
    ...
    if params.threshold >= -1 && params.threshold <= 1
        % Manual threshold
        mask = R_Vessel >= params.threshold;
        graphThreshHistogram(R_Vessel, params.threshold, mask, cmap, [prefix '_2_3']);
    else
        % Automatic Otsu thresholding
        mask = autoOtsuThresholding(R_Vessel, maskVesselnessClean, params.classes, [prefix '_2_3']);
