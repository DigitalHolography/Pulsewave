function [mask, R_Vessel] = processVascularSignal(M0_ff_video, maskClean, maskVesselnessClean, corrParams, cmap, prefix, TB)
    ...
    saveImage(rescale(R_Vessel), TB, sprintf("%s_2_1_CorrelMatrix.png", prefix), isStep = true);
    ...
    saveImage(rescale(R_Vessel), TB, sprintf("%s_2_2_R_Vessel.png", prefix), isStep = true);
    ...
    saveImage(mask, TB, sprintf("%s_2_4_Thresh.png", prefix), isStep = true, cmap = cmap);
end