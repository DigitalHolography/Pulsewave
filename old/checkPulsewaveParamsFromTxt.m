...
if txt_exists 
    ...
    local_background_width = 15;
    arteryMask_vesselness_sigma = 3;
    arteryMask_vesselness_beta = 0.8;
    arteryMask_vesselness_bin_threshold = 0.35; 
    arteryMask_magicwand_nb_of_area_vessels = 3;
    arteryMask_magicwand_nb_of_area_artery = 3;
    arteryMask_ArteryCorrThreshold = 0.07;
    centralRetinal_arteryThreshold = 3;
    centralRetinal_veinThreshold = -3;
    centralRetinal_backgndThreshold = 2 ;
    vesselMask_BinTreshold = 0.15 ;
    masks_radius = 0.15; 
    masks_minSize = 150;
    masks_cleaningCoroid = true;
    masks_showIntermediateFigures = false;
    RG_FloorThreshold = 0.33;
    RG_veinConditionThreshold = 0.33;
    RG_ArteryConditionThreshold = 2;
    CRACRV_Threshold = 3;
    RG_alpha = -0.0025 ;
    ...
    'Local background width :\n%f\n', ...
    ...
    '\nCreation of masks\n', ... %createMasks
    'Vesselnes parameter sigma :\n%f\n', ... % line 8
    'Vesselnes parameter beta :\n%f\n', ... % line 9
    'Vesselness Binarization treshold :\n%f\n', ... % line 10
    'MagicWand Number of segmented area detected for vessels :\n%f\n', ... % line 12
    'MagicWand Number of segmented area detected for artery :\n%f\n', ... % line 12
    'Artery correlation threshold :\n%f\n', ... % line 55
    ...
    ...
    ...
    'Minimum seed area size :\n%f\n', ... 
    'Cleaning Coroid or not :\n%f\n', ... 
    'Showing intermediate figures in the process :\n%f\n', ... 
    'Region growing floor threshold :\n%f\n', ... 
    'Region growing vein condition threshold :\n%f\n', ... 
    'Region growing artery condition threshold :\n%f\n', ... 
    'Central Retina Vein/Artery threshold :\n%f\n', ... 
