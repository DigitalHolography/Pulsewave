...
parfor circleIdx = 1:numCircles
    ...
    [vr_avg, vr_std, area, top_velocity, std_velocity, maskCross, v_profiles_avg, v_profiles_std, subImg_cell, width_avg, width_std, rejected_masks] = crossSectionAnalysis2(ToolBox, locs{circleIdx}, widths{circleIdx}, mask, v_RMS, flowRate_sliceHalfThickness, name, flagBloodVelocityProfile, circleIdx, force_width);
