...
imwrite(rescale(squeeze(mean(f_RMS_background, 3))), fullfile(ToolBox.PW_path_png, 'pulseAnalysis', sprintf("%s_%s", ToolBox.main_foldername, '6_frequency_RMS_bkg.png')), 'png');
